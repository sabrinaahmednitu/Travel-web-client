...
const ManageBooking = () => {
    ...
    useEffect(() => {
        fetch("https://protected-eyrie-47444.herokuapp.com/manageallorder")
            .then((res) => res.json())
    ...
    const handleDelete = (id) => {
        ...
        if (proceed) {
            fetch(
                `https://protected-eyrie-47444.herokuapp.com/mybooking/${id}`,
                {
                    method: "DELETE",
                }
            )
    ...
    const handleUpdate = (id) => {
        ...
        const uri = `https://protected-eyrie-47444.herokuapp.com/mybooking/${id}`;
        fetch(uri, {
            method: "PUT",
            headers: {
